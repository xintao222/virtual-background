...
RenderingPipeline.prototype.loadTFLiteModel = async function (tflite, segmentationConfig){
	...
	const modelResponse = await fetch(`lib/tflite/models/${modelFileName}.tflite`);
...
RenderingPipeline.prototype.useRenderingPipeline = async function (sourcePlayback, backgroundConfig, segmentationConfig, backgroundImageRef, callback){
	...
	function getPipeline(){
		...
		// 		This.visibilityRenderRequestId = window.setInterval(async function (){
		// 			await newPipeline.render()
		// 		} , 1000 / 60)
		// 	}else {
		// 		clearInterval(This.visibilityRenderRequestId)
		// 		This.visibilityRenderRequestId = null
		// 	}
		// });
